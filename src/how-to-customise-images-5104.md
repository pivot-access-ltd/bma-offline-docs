...
<a href="#heading--why-customised-ubuntu-deployments-arent-supported"><h2 id="heading--why-customised-ubuntu-deployments-arent-supported">Why customised Ubuntu deployments aren't supported</h2></a>
...
<a href="#heading--warnings-on-creating-a-custom-ubuntu-image"><h2 id="heading--warnings-on-creating-a-custom-ubuntu-image">Warnings on creating a custom Ubuntu image</h2></a>
...
<a href="#heading--how-to-create-a-custom-ubuntu-image-for-maas"><h2 id="heading--how-to-create-a-custom-ubuntu-image-for-maas">How to create a custom Ubuntu image for MAAS</h2></a>
...
<a href="#heading--Install-packer"><h3 id="heading--Install-packer">Install packer</h3></a>
...
<a href="#heading--Install-Ubuntu-template-dependencies"><h3 id="heading--Install-Ubuntu-template-dependencies">Install Ubuntu template dependencies</h3></a>
...
<a href="#heading--Get-the-available-packer-templates"><h3 id="heading--Get-the-available-packer-templates">Get the available packer templates</h3></a>
...
<a href="#heading--Build-an-Ubuntu-raw-image-with-packer"><h3 id="heading--Build-an-Ubuntu-raw-image-with-packer">Build an Ubuntu raw image with packer</h3></a>
...
<a href="#heading--Validate-the-build"><h3 id="heading--Validate-the-build">Validate the build</h3></a>
...
<a href="#heading--Alternative-Run-packer-manually"><h3 id="heading--Alternative-Run-packer-manually">Alternative: Run packer manually</h3></a>
...
<a href="#heading--Upload-the-Ubuntu-image-to-MAAS"><h3 id="heading--Upload-the-Ubuntu-image-to-MAAS">Upload the Ubuntu image to MAAS</h3></a>
...
<a href="#heading--Verify-your-custom-image"><h3 id="heading--Verify-your-custom-image">Verify your custom image</h3></a>
...
<a href="#heading--Log-into-your-deployed-image-and-verify-that-its-right"><h3 id="heading--Log-into-your-deployed-image-and-verify-that-its-right">Log into your deployed image and verify that it's right</h3></a>
...
<a href="#heading--Verify-the-requirements"><h3 id="heading--Verify-the-requirements">Verify the requirements</h3></a>
...
<a href="#heading--Install-RHEL7-template-dependencies"><h3 id="heading--Install-RHEL7-template-dependencies">Install RHEL7 template dependencies</h3></a>
...
<a href="#heading--Locate-the-RHEL7-template"><h3 id="heading--Locate-the-RHEL7-template">Locate the RHEL7 template</h3></a>

The packer template in the directory `rhel7` subdirectory creates a RHEL 7 AMD64 image for use with MAAS.

<a href="#heading--Obtain-the-RHEL7-DVD-ISO"><h3 id="heading--Obtain-the-RHEL7-DVD-ISO">Obtain the RHEL7 DVD ISO</h3></a>
...
<a href="#heading--Customizing-the-image-if-desired"><h3 id="heading--Customizing-the-image-if-desired">Customizing the image, if desired</h3></a>
...
<a href="#heading--Set-up-a-proxy-for-building-the-image-if-desired"><h3 id="heading--Set-up-a-proxy-for-building-the-image-if-desired">Set up a proxy for building the image, if desired</h3></a>
...
<a href="#heading--Build-the-RHEL7-image"><h3 id="heading--Build-the-RHEL7-image">Build the RHEL7 image</h3></a>
...
<a href="#heading--Upload-the-RHEL7-image-to-MAAS"><h3 id="heading--Upload-the-RHEL7-image-to-MAAS">Upload the RHEL7 image to MAAS</h3></a>
...
<a href="#heading--Install-RHEL8-template-dependencies"><h3 id="heading--Install-RHEL8-template-dependencies">Install RHEL8 template dependencies</h3></a>
...
<a href="#heading--Locate-the-RHEL8-template"><h3 id="heading--Locate-the-RHEL8-template">Locate the RHEL8 template</h3></a>

The packer template in the directory `rhel8` subdirectory creates a RHEL 8 AMD64 image for use with MAAS.

<a href="#heading--Obtain-the-RHEL8-DVD-ISO"><h3 id="heading--Obtain-the-RHEL8-DVD-ISO">Obtain the RHEL8 DVD ISO</h3></a>
...
<a href="#heading--Build-the-RHEL8-image"><h3 id="heading--Build-the-RHEL8-image">Build the RHEL8 image</h3></a>
...
<a href="#heading--Upload-the-RHEL8-image-to-MAAS"><h3 id="heading--Upload-the-RHEL8-image-to-MAAS">Upload the RHEL8 image to MAAS</h3></a>
...
<a href="#heading--Install-CentOS-7-template-dependencies"><h3 id="heading--Install-CentOS-7-template-dependencies">Install CentOS 7 template dependencies</h3></a>
...
<a href="#heading--Locate-the-CentOS-7-template"><h3 id="heading--Locate-the-CentOS-7-template">Locate the CentOS 7 template</h3></a>

The packer template in the directory `centos7` subdirectory creates a CentOS 7 AMD64 image for use with MAAS.

<a href="#heading--Customise-the-image-if-desired"><h3 id="heading--Customise-the-image-if-desired">Customise the image, if desired</h3></a>
...
<a href="#heading--Build-the-CentOS-7-image"><h3 id="heading--Build-the-CentOS-7-image">Build the CentOS 7 image</h3></a>
...
<a href="#heading--Upload-the-CentOS-7-image-to-MAAS"><h3 id="heading--Upload-the-CentOS-7-image-to-MAAS">Upload the CentOS 7 image to MAAS</h3></a>
...
<a href="#heading--Verify-the-requirements-and-accept-the-limitations"><h3 id="heading--Verify-the-requirements-and-accept-the-limitations">Verify the requirements and accept the limitations</h3></a>

VMware ESXi has a specific set of requirements and limitations which are more stringent than MAAS.

<a href="#heading--Basic-requirements"><h4 id="heading--Basic-requirements">Basic requirements</h4></a>
...
<a href="#heading--libvirt-testing"><h4 id="heading--libvirt-testing">libvirt testing</h4></a>
...
<a href="#heading--Known-storage-limitations"><h4 id="heading--Known-storage-limitations">Known storage limitations</h4></a>
...
<a href="#heading--Known-networking-limitations"><h4 id="heading--Known-networking-limitations">Known networking limitations</h4></a>
...
<a href="#heading--Image-fails-to-build-due-to-qemu-nbd-error"><h4 id="heading--Image-fails-to-build-due-to-qemu-nbd-error">Image fails to build due to qemu-nbd error</h4></a>
...
<a href="#heading--Prerequisites-to-create-and-deploy-images"><h4 id="heading--Prerequisites-to-create-and-deploy-images">Prerequisites to create and deploy images</h4></a>
...
<a href="#heading--Install-ESXi-template-dependencies"><h3 id="heading--Install-ESXi-template-dependencies">Install ESXi template dependencies</h3></a>

```nohighlight
sudo apt install qemu-utils
```

<a href="#heading--Install-Python-pip-if-not-installed"><h3 id="heading--Install-Python-pip-if-not-installed">Install Python `pip`, if not installed</h3></a>
...
<a href="#heading--Locate-the-ESXi-template"><h3 id="heading--Locate-the-ESXi-template">Locate the ESXi template</h3></a>
...
<a href="#heading--Build-the-ESXi-image"><h3 id="heading--Build-the-ESXi-image">Build the ESXi image</h3></a>
...
<a href="#heading--Upload-the-ESXi-image-to-MAAS"><h3 id="heading--Upload-the-ESXi-image-to-MAAS">Upload the ESXi image to MAAS</h3></a>
