...
- [1867812](https://bugs.launchpad.net/bugs/1867812): maas 2.7 regression: creates partition when trying to use entire disk as bcache cache device
- [1992330](https://bugs.launchpad.net/bugs/1992330): Use the rack controller IP as DNS when relaying DHCP
- [1889026](https://bugs.launchpad.net/bugs/1889026): After "mark broken" and "mark fixed" it's no longer possible to mark the machine broken again
- [1992330](https://bugs.launchpad.net/bugs/1992330): Use the rack controller IP as DNS when relaying DHCP
