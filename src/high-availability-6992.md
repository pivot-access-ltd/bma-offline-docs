...
<a href="#heading--rack-controller-ha"><h2 id="heading--rack-controller-ha">High availability mode</h2></a>
...
<a href="#heading--bmc-ha"><h3 id="heading--bmc-ha">BMC control (node power cycling)</h3></a>
